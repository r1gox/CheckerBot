...
elseif((strpos($message, "!py") === 0)||(strpos($message, "/py") === 0)||(strpos($message, ".py") === 0)){
...
$respuesta = "━━━━━━•⟮sᴛʀɪᴘᴇ⟯•━━━━━━\n\n❗𝙵𝙾𝚁𝙼𝙰𝚃𝙾 1: /py cc|m|y|cvv\n❗𝙵𝙾𝚁𝙼𝙰𝚃𝙾 2: !py cc|m|y|cvv\n❗𝙵𝙾𝚁𝙼𝙰𝚃𝙾 3: .py cc|m|y|cvv\n";
sendMessage($chat_id,$respuesta, $message_id);
die();
}
